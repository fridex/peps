...
mentioned JSON file captures additional metadata to allow recording URL to a
...
information about wheels during debugging issues to make sure a desired wheel
...
stating information about packages installed from an URL, installers SHOULD
...
no backwards compatibility implications to consider in ``provenance_url.json``
...
.. [1] `A patch to pip supporting this feature
